...
;
create index ix_payer on report_rptcollection_annual_bypayer(payer_name(200))
;
...
update itemaccount set state = 'ACTIVE' 
where objid in ('RPT_BASIC_CURRENT_PROVINCE_SHARE', 'RPT_BASIC_PREVIOUS_PROVINCE_SHARE')
;
