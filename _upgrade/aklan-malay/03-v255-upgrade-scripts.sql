...
alter table afunit modify itemid varchar(50) character set latin1 not null 
;
...
alter table af_control_detail modify controlid varchar(50) character set latin1 not null 
; 
alter table af_control_detail 
...
alter table cashreceipt modify controlid varchar(50) character set latin1 not null 
;
set foreign_key_checks=0;
